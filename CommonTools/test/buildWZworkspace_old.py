...
binning=[]
for i in range(1, data_obs.GetNbinsX()):
    print i
    binning[i]=data_obs.GetBinLowEdge(i)
binning[data_obs.GetNbinsX()+1]=data_obs.GetBinLowEdge(data_obs.GetNbinsX()+1)

print "bining: "
for i in range(0, binning.size()-1):
    print binning[i]

wpt.setBinning(binning)
