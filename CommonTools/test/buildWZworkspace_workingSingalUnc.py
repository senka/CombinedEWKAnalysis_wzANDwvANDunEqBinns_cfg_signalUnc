...
#            doSignalShape_unc = True
    ...
    if (doSignalShape_unc):
        ...
        print 'signalshapeName=',signal_shapeSyst[0]
        print 'signalshapeName=%sUp'%signal_shapeSyst[0]
        diboson_up = f.Get('%sUp'%signal_shapeSyst[0])
        diboson_down = f.Get('%sDown'%signal_shapeSyst[0])
